...
\node[draw, minimum height= .6cm, minimum width= .6cm](c) at (0,-1) {K};
\node[draw, minimum height= .6cm, minimum width= .6cm](d) at (1,-1) {D};
\node[draw, minimum height= .6cm, minimum width= .6cm](e) at (2,-1) {G};
\node[draw, minimum height= .6cm, minimum width= .6cm](f) at (3,-1) {H};
\node[draw, minimum height= .6cm, minimum width= .6cm](g) at (4,-1) {B};
\node[draw, minimum height= .6cm, minimum width= .6cm](h) at (5,-1) {A};
\node[draw, minimum height= .6cm, minimum width= .6cm](i) at (6,-1) {C};
...
\node[draw, gray!25, minimum height= .6cm, minimum width= .6cm](a) at (-2, -1) {J};
\node[draw, gray!25, minimum height= .6cm, minimum width= .6cm](b) at (-1, -1) {Å};
...
\node[draw, gray!25, minimum height= .6cm, minimum width= .6cm](j) at (7, -1) {I};
\node[draw, gray!25, minimum height= .6cm, minimum width= .6cm](k) at (8, -1) {W};
